...
public class Bank {
    ...
    public Bank(String name, String country, EnumSet<DepositType> depositTypes, String depositor, int accountId, int amountOnDeposit, int profitability, LocalDate duration) {
        this.name = name;
        this.country = country;
